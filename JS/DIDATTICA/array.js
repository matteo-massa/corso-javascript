...
//LE STRINGHE SONO EQUIPARABILI IN LETTURA AD ARRAY DI CARATTERI
let stringa = 'Ho già fame';
...
stringa[0] = 'C'; //la stringa è immutabile quindi non posso andare a cambiare uno o più caratteri;
console.log(stringa);
