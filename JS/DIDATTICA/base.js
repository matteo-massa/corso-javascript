...
//OGGETTO MATH
let numeri = [2, 6, 4, 1, 5];
console.log(Math.min(...numeri)); //... SpreadOperator

let numeri2 = [...numeri];
numeri2[0] = 50;
console.log(numeri);
console.log(numeri2);
let numeri3 = [3, 4, 5, 6, ...numeri2];
console.log(numeri3);
let numeri4 = [...numeri2, ...numeri];
console.log(numeri4);

//le costanti vanno dichiarate e inizializzate in un'unica istruzione
const ERROR_MSG = 'campo non valido';

//tutti i metodi delle stringhe non modificano la stringa originale perchè le stringhe sono immutabili
let frase = '  ho aggiunto due spazi a sinistra e quattro a destra    ';
...
frase.replace('spazi', 'buchi');
console.log(frase);
console.log(frase.replace('spazi', 'buchi'));
