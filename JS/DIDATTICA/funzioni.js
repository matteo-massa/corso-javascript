...
//FUNZIONI CON NUMERO DI PARAMETRI VARIABILE (... REST OPERATOR)

function sommaRest(num1, num2, ...numeri) {
  let somma = num1 + num2;
  for (let numero of numeri) {
    somma += numero;
  }
...
console.log(concatenaStr(3, 'ciao', true, 45, false));
